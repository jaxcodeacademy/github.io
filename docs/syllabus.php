...
<h2 class="section-title">Syllabus</h2><br>
<p><a href="https://vimeo.com/user99332130/videos" target="_blank" class="btn btn-info" style="color:#ffffff;">Video Lessons at Vimeo</a> <a href="https://awwapp.com/" target="_blank" class="btn btn-success" style="color:#ffffff;">Online Whiteboard</a></p>
...
<li role=presentation class=active><a href=#lamp role=tab id=profile-tab data-toggle=tab aria-controls=profile>LAMP Syllabus</a></li> 
...
<!--li role=presentation><a href=#home id=home-tab role=tab data-toggle=tab aria-controls=home aria-expanded=true>Course & Profile Info</a></li--> 
</ul> 
...
<p><a href="https://meet.google.com/bhn-tbtf-djo" target="_blank" class="btn btn-warning" style="color:#ffffff;">Google Meet link for online students</a></p>




<p><a href="https://vimeo.com/user99332130/videos" target="_blank" class="btn btn-info" style="color:#ffffff;">Video Lessons at Vimeo</a></p> 



<p class="well">
<strong>Web Hosting - OpalStack Student Account:</strong><br><br>

<strong>SFTP/SSH Credentials:</strong> 
<br>
Host Name: opal10.opalstack.com<br>
Username: jca<?=$_SESSION['student_id']?><br>
Password: <?=$_SESSION['opalstackpass']?><br>

<br>
<strong>Database Credentials:</strong><br>
Adminer: <a href="https://opal10.opalstacked.com/adminer/" target="_blank">https://opal10.opalstacked.com/adminer/</a><br>
Database: jca<?=$_SESSION['student_id']?><br>
Password: <?=$_SESSION['mariadbpass']?>
</p>
...
<!-- LAMP CONTENT -->
 <div class="tab-pane fade in active" role=tabpanel id=lamp aria-labelledby=profile-tab> <br><br> <p>
 <?
...
<ol>
	...
	<li>Express - Controllers</li>
	<li>Express - Middleware</li>
	<li>Express - Models w/ Mongoose</li>
	<li>Mongoose - CRUD operations</li>
	<li>Mongoose - Filtering Results</li>
	<li>Express - Authentication w/ JWT</li>
	<li>Express - Encryption w/ Argon2</li>
	<li>React - Application Setup</li>
	<li>React - Basic Component</li>
	<li>React - Props</li>
	<li>React - useState</li>
	<li>React - useContext</li>
	<li>React - State management libraries</li>
	<li>React - useEffect</li>
	<li>React - Working w/ Asynchronous Data</li>
	<li>React - React Router</li>
	<li>React - Making HTTP requests w/ Axios</li>
</ol>
 ...
 <!-- CYBER CONTENT -->
  <div class="tab-pane fade" role=tabpanel id=cyber aria-labelledby=profile-tab> <br><br>
  
  <p>Lesson 1 - <a href="cyber-lesson-1.php">Network Hacking: Create a Hacking Lab with VirtualBox</a></p>
  
  
   <p>
  <a href="https://jaxcode.com/docs/cyber-project-terms.php" class="btn">Cyber Assignment Due Monday</a>
 <?
