...
<h2 class="section-title">PHP Basics</h2>
...
<!-- code block -->
<div class="code-block">
<pre><code class="language-markup">$txt = &lt;&lt;&lt;EOT
...
<ul>
	<li>Create a folder named '100' and put your files in there.  Upload to Opalstack</li>
	...
	<li>All pages should go into a new folder named 'numbers'.</li>
...
<!-- code block -->
<div class="code-block">
<pre><code class="language-markup">https://jaxcode.com/stateflags/Alabama.svg.png</code></pre>
</div><!--/code-block-->
