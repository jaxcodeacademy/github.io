...
switch ($_SESSION['lessonslug']) {
    ...
    case "loginandregister":
        $lessontitle = 'Registration &amp; Login';
        $sections = array("$lessontitle", "Assignment");
        break;
    case "api":
        $lessontitle = 'API';
        $sections = array("$lessontitle", "Assignment");
    ...
    case "ajax":
        $lessontitle = 'AJAX';
        $sections = array("AJAX", "AJAX PHP", "Assignments");
        break;
    case "html":
        $lessontitle = 'HTML';
        $sections = array("$lessontitle", "Assignments");
    ...
    case "phpbasics":
        ...
        break;
    case "phpbasics2":
        $lessontitle = 'PHP Date';
        $sections = array("$lessontitle", "Switch Statement", "Assignments");
        break;
    case "phpchallenges":
        $lessontitle = 'PHP Challenges';
        $sections = array("$lessontitle", "Basic Challenges", "Assignments");
        break;
    case "phpmysql":
    ...
    case "wordpress":
        ...
        $sections = array("$lessontitle", "Assignments");
        break;
	case "wordpresstemplates":
        $lessontitle = 'Wordpress Templates';
        $sections = array("$lessontitle", "Assignments");
        break;
	case "react":
        $lessontitle = 'React';
        ...
        break;
    case "xml":
        $lessontitle = 'XML/JSON';
        $sections = array("$lessontitle", "Assignments");
        break;

    case "phplogin":
        $lessontitle = 'Login & Registration';
        $sections = array("$lessontitle","PHP Redirect", "PHP Cookies", "PHP Sessions", "Assignments");
        break;
    default:
...
<? include 'lessons/'.$_SESSION['lessonslug'].'.php'; ?>
