...
<head>
    <title>Jax Code Academy Payment Confirmation</title>
    <!-- Meta -->
    <meta charset="utf-8">
        ...
        <div class="doc-wrapper">
            <div class="container">
                <div id="doc-header" class="doc-header text-center">
                    <h1 class="doc-title"><span aria-hidden="true" class="icon icon_creditcard"></span> Payment Processed Successfully</h1>
...
Your payment has been processed. Go back to <a href="index.php">My Account</a>
