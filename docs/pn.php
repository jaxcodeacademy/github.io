    ...
    <div class="modal-content">
      ...
      <div class="modal-body text-left" id="printableArea">
        PROMISSORY NOTE<br><br>
            ...
            FOR VALUE RECEIVED, <?=$_SESSION['firstname']?> <?=$_SESSION['lastname']?>, (the "Maker"), hereby promises to pay to the order of Jax Code Academy Inc. ("Payee"), the principal sum of $5,000.00 pursuant to the terms and conditions set forth herein.<br><br>

            PAYMENT OF PRINCIPAL.  The principal amount of this Promissory Note (the "Note") shall be due and payable in 10 monthly installments beginning when the first payment is made by subscription via Paypal.<br><br>
