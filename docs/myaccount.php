...
<h2 class="section-title">Pay with Paypal or Credit Card</h2><br>
</p>
<div class="section-block">

<div class="text-center">

<h3 class="block-title">Pay Tuition</h3>
<p>Total tuition for paying before class starts is <mark>$<?=number_format($tuition, 2)?></mark>.<br> $1,000 deposit is required now to reserve your seat. <br> Tuition balance is due before the first day of class. </p>
<p>
