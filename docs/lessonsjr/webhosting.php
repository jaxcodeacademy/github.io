<section id="webhosting" class="doc-section">
<h2 class="section-title">Web Hosting</h2>
...
<div class="row">
<div class="col-md-12 col-sm-12 col-xs-12">
<br><h4>1. Create a new subdomain</h4>
<img src="lessons/images/add-new-domain.jpg" style="width:100%;">
<br><br>
<h4>2. Create a new application</h4>
<img src="lessons/images/add-new-application.jpg" style="width:100%;">
<br><br>
<h4>3. Create a new website</h4>
<img src="lessons/images/add-new-website.jpg" style="width:100%;">
<br><br>
<h4>4. Create a new database</h4>
<img src="lessons/images/add-new-db.jpg" style="width:100%;">
<br><br>
<h4>5. Create a database user</h4>
<img src="lessons/images/add-db-user.jpg" style="width:100%;">
<br><br>
</div>
</div>
</section><!--//doc-section-->
